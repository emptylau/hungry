...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.27 2015-12-31 05:30:54 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_f__form1:
		return (void*)soap_instantiate_f__form1(soap, -1, type, arrayType, n);
	case SOAP_TYPE_f__formResponse:
		return (void*)soap_instantiate_f__formResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_f__form2:
		return (void*)soap_instantiate_f__form2(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE_f__form1:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct f__form1*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct f__form1*>(p->ptr));
		break;
	case SOAP_TYPE_f__formResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct f__formResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct f__formResponse*>(p->ptr));
		break;
	case SOAP_TYPE_f__form2:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct f__form2*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct f__form2*>(p->ptr));
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_ns__div:
		...
		*(struct ns__div*)p = *(struct ns__div*)q;
		break;
	case SOAP_TYPE_f__form1:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct f__form1 type=%d location=%p object=%p\n", t, p, q));
		*(struct f__form1*)p = *(struct f__form1*)q;
		break;
	case SOAP_TYPE_f__formResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct f__formResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct f__formResponse*)p = *(struct f__formResponse*)q;
		break;
	case SOAP_TYPE_f__form2:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct f__form2 type=%d location=%p object=%p\n", t, p, q));
		*(struct f__form2*)p = *(struct f__form2*)q;
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
...
f__form2::f__form2()
{
	soap_default_f__form2(NULL, this);
}
...
SOAP_FMAC3 struct f__form2 * SOAP_FMAC4 soap_in_f__form2(struct soap *soap, const char *tag, struct f__form2 *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct f__form2 *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_f__form2, sizeof(struct f__form2), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct f__form2 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__form2, SOAP_TYPE_f__form2, sizeof(struct f__form2), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct f__form2 * SOAP_FMAC2 soap_instantiate_f__form2(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_f__form2(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct f__form2 *p;
	size_t k = sizeof(struct f__form2);
	if (n < 0)
	{	p = SOAP_NEW(struct f__form2);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct f__form2, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct f__form2 location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_f__form2, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_f__form2(soap, tag?tag:"f:form2", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
f__formResponse::f__formResponse()
{
	soap_default_f__formResponse(NULL, this);
}
...
SOAP_FMAC3 struct f__formResponse * SOAP_FMAC4 soap_in_f__formResponse(struct soap *soap, const char *tag, struct f__formResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct f__formResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_f__formResponse, sizeof(struct f__formResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct f__formResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__formResponse, SOAP_TYPE_f__formResponse, sizeof(struct f__formResponse), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct f__formResponse * SOAP_FMAC2 soap_instantiate_f__formResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_f__formResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct f__formResponse *p;
	size_t k = sizeof(struct f__formResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct f__formResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct f__formResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct f__formResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_f__formResponse, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_f__formResponse(soap, tag?tag:"f:formResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
f__form1::f__form1()
{
	soap_default_f__form1(NULL, this);
}
...
SOAP_FMAC3 struct f__form1 * SOAP_FMAC4 soap_in_f__form1(struct soap *soap, const char *tag, struct f__form1 *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct f__form1 *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_f__form1, sizeof(struct f__form1), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct f__form1 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__form1, SOAP_TYPE_f__form1, sizeof(struct f__form1), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct f__form1 * SOAP_FMAC2 soap_instantiate_f__form1(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_f__form1(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct f__form1 *p;
	size_t k = sizeof(struct f__form1);
	if (n < 0)
	{	p = SOAP_NEW(struct f__form1);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct f__form1, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct f__form1 location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_f__form1, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_f__form1(soap, tag?tag:"f:form1", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_f__formResponse, NULL);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct f__formResponse ** SOAP_FMAC4 soap_in_PointerTof__formResponse(struct soap *soap, const char *tag, struct f__formResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct f__formResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_f__formResponse, sizeof(struct f__formResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	if (soap_out_PointerTof__formResponse(soap, tag?tag:"f:formResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
