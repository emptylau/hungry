...
SOAP_FMAC1 struct f__form2 * SOAP_FMAC2 soap_instantiate_f__form2(struct soap*, int, const char*, const char*, size_t*);

inline struct f__form2 * soap_new_f__form2(struct soap *soap, int n = -1) { return soap_instantiate_f__form2(soap, n, NULL, NULL, NULL); }

inline struct f__form2 * soap_new_req_f__form2(
	struct soap *soap)
{	struct f__form2 *_p = soap_new_f__form2(soap);
	if (_p)
	{	soap_default_f__form2(soap, _p);
	}
	return _p;
}

inline struct f__form2 * soap_new_set_f__form2(
	struct soap *soap)
{	struct f__form2 *_p = soap_new_f__form2(soap);
	if (_p)
	{	soap_default_f__form2(soap, _p);
...
SOAP_FMAC1 struct f__formResponse * SOAP_FMAC2 soap_instantiate_f__formResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct f__formResponse * soap_new_f__formResponse(struct soap *soap, int n = -1) { return soap_instantiate_f__formResponse(soap, n, NULL, NULL, NULL); }

inline struct f__formResponse * soap_new_req_f__formResponse(
	struct soap *soap,
	double result)
{	struct f__formResponse *_p = soap_new_f__formResponse(soap);
	if (_p)
	{	soap_default_f__formResponse(soap, _p);
		_p->result = result;
	}
	return _p;
}

inline struct f__formResponse * soap_new_set_f__formResponse(
	struct soap *soap,
	double result)
{	struct f__formResponse *_p = soap_new_f__formResponse(soap);
	if (_p)
...
SOAP_FMAC1 struct f__form1 * SOAP_FMAC2 soap_instantiate_f__form1(struct soap*, int, const char*, const char*, size_t*);

inline struct f__form1 * soap_new_f__form1(struct soap *soap, int n = -1) { return soap_instantiate_f__form1(soap, n, NULL, NULL, NULL); }

inline struct f__form1 * soap_new_req_f__form1(
	struct soap *soap)
{	struct f__form1 *_p = soap_new_f__form1(soap);
	if (_p)
	{	soap_default_f__form1(soap, _p);
	}
	return _p;
}

inline struct f__form1 * soap_new_set_f__form1(
	struct soap *soap)
{	struct f__form1 *_p = soap_new_f__form1(soap);
	if (_p)
	{	soap_default_f__form1(soap, _p);
